...
#include "objrepr_bus_node.h"
#include "config_reader.h"
#include "system_environment_facade_node.h"

using namespace std;
using namespace common_types;

static constexpr const char * PRINT_HEADER = "SystemEnvironmentNode:";

SystemEnvironmentFacadeNode::SystemEnvironmentFacadeNode()
{
...
bool SystemEnvironmentFacadeNode::init( const SInitSettings & _settings ){
